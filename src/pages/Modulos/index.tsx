...
export default function Modulos() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSucesso("Módulo cadastrado com sucesso!");
    carregarDados();
  };
  ...
  return (
    <div className="container py-4">
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              ...
              <div className="col-md-5">
                <FormField label="Título do Módulo" name="titulo" value={form.titulo} onChange={handleChange} placeholder="Ex: Introdução ao React" required />
              </div>
      ...
      <div className="card shadow-sm">
        ...
        <div className="card-body">
          <DataTable colunas={colunas} dados={modulosOrdenados} onRemover={handleRemover} />
        </div>
      </div>
    </div>
  );
